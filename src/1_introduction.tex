...
\item A novel architecture using a gating hypernetwork that can generate diverse multi-class results for both class conditioned and InfoGAN-style applications. \ow{maybe fix infogan with description}
