...
\begin{figure*}%[ht!]
    ...
    \addSubFigEighth{munit_all/cityscapes_95_fake_B}{MUNIT Conditioning all layers}{fig:city_munit}
...
\begin{figure*}%[ht!]
    ...
    \addSubFigEighth{munit_all/night2day_58_5018_to_5000_fake_B}{MUNIT Conditioning all layers}{fig:city_munit}
