...
\begin{figure}%[ht!]
    \centering
    \addSubFigHalf{gated_G_act}{Activations of the gated residual blocks in the generator}{fig:gen_act} 
    \addSubFigHalf{gated_D_act}{Activations of the gated residual blocks in the discriminator}{fig:dis_act} 
