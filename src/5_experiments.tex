...
\begin{figure*}%[ht!]
    ...
    \addSubFigSixthLabel{channel_gated/soccer_18_real_A}{soccer}{fig:soccer_input}
    ...
    \addSubFigSixthLabel{channel_gated/orange_17_real_A}{cookie}{fig:orange_input}
    ...
    \addSubFigSixthLabel{channel_gated/watermelon_17_real_A}{cookie}{fig:watermelon_input}
    ...
    \addSubFigSixthLabel{channel_gated/cupcake_27_real_A}{cookie}{fig:cupcake_input}
    ...
    \addSubFigSixthLabel{channel_gated/strawberry_1_real_A}{cookie}{fig:strawberry_input}
    ...
    \addSubFigSixthLabel{channel_gated/chicken_2_real_A}{cookie}{fig:chicken_input}
